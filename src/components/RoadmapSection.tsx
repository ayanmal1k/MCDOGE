  ...
  const phases: Phase[] = [
    {
      ...
      goals: [
        ...
        "Community takeovers and daily viral meme preparations.",
        "Reaching the first 1,000+ Happy Meal holders.",
      ],
    },
    {
      id: 1,
      number: "PHASE 2",
      title: "MCDELIVERY ENGINE",
    ...
    },
    {
      id: 2,
      number: "PHASE 3",
      title: "FRANCHISING THE NARRATIVE",
      videoSrc: "/Roadmap/3.webm",
      goals: [
        "Centralized Exchange (CEX) listings.",
        "Real-world community campaigns in MCDOGE merch.",
        "Custom NFT collection representing the McDoge delivery fleet.",
        "Growing our global crew to 15,000+ active members.",
      ],
    },
    {
      id: 3,
      ...
      goals: [
        ...
        "Integrating MCDOGE into crypto payment gateways for fast food.",
